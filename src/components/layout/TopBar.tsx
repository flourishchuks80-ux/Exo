...
import { MessageSquare, Shield, Loader2, Menu } from "lucide-react";
          ...
          <div className="flex items-center gap-2">
            {authenticated && (
              <button
                ...
                className="lg:hidden p-1.5 rounded-lg text-[#4F5E7A] hover:text-[#F0F4FF] hover:bg-[#192235] transition-colors"
